...
from .models import IDC, Cabinet, Area, Domain, DeviceInfo, Code, ConnectionInfo, DeviceFile
...
class IDCView(LoginRequiredMixin, BreadcrumbMixin, TemplateView):
    template_name = 'cmdb/idc.html'


class IDCCreateView(SandboxCreateView):
    model = IDC
    fields = '__all__'


class IDCUpdateView(SandboxUpdateView):
    model = IDC
    fields = '__all__'


class IDCListView(SandboxListView):
    model = IDC
    fields = ['id', 'name', 'memo']
...
class IDCDeleteView(SandboxDeleteView):
    model = IDC

class AreaView(LoginRequiredMixin, BreadcrumbMixin, TemplateView):
    template_name = 'cmdb/area.html'

    def get_context_data(self):
        self.kwargs['all_idc'] = IDC.objects.all()
        return super().get_context_data(**self.kwargs)


class AreaCreateView(SandboxCreateView):
    model = Area
    fields = '__all__'
...
class AreaUpdateView(SandboxUpdateView):
    model = Area
    fields = '__all__'
...
class AreaListView(SandboxListView):
    model = Area
    fields = ['id', 'name', 'position', 'memo']
...
class AreaDeleteView(SandboxDeleteView):
    model = Area

class DomainView(LoginRequiredMixin, BreadcrumbMixin, TemplateView):
    template_name = 'cmdb/domain.html'

    def get_context_data(self):
        self.kwargs['all_area'] = Area.objects.all()
        return super().get_context_data(**self.kwargs)


class DomainCreateView(SandboxCreateView):
    model = Domain
    fields = '__all__'
...
class DomainUpdateView(SandboxUpdateView):
    model = Domain
    fields = '__all__'
...
class DomainListView(SandboxListView):
    model = Domain
    fields = ['id', 'name', 'position', 'memo']
...
class DomainDeleteView(SandboxDeleteView):
    model = Domain
...
class CabinetView(LoginRequiredMixin, BreadcrumbMixin, TemplateView):
    ...
    def get_context_data(self):
        self.kwargs['all_domain'] = Domain.objects.all()
        return super().get_context_data(**self.kwargs)
